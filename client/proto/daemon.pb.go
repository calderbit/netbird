...
type PeerState struct {
	...
	ScionActive                bool                   `protobuf:"varint,21,opt,name=scionActive,proto3" json:"scionActive,omitempty"`
	ScionPath                  string                 `protobuf:"bytes,22,opt,name=scionPath,proto3" json:"scionPath,omitempty"`
	ScionLatency               *durationpb.Duration   `protobuf:"bytes,23,opt,name=scionLatency,proto3" json:"scionLatency,omitempty"`
	ScionPathCount             int32                  `protobuf:"varint,24,opt,name=scionPathCount,proto3" json:"scionPathCount,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *PeerState) GetScionActive() bool {
	if x != nil {
		return x.ScionActive
	}
	return false
}

func (x *PeerState) GetScionPath() string {
	if x != nil {
		return x.ScionPath
	}
	return ""
...
func (x *PeerState) GetScionLatency() *durationpb.Duration {
	if x != nil {
		return x.ScionLatency
	}
	return nil
}

func (x *PeerState) GetScionPathCount() int32 {
	if x != nil {
		return x.ScionPathCount
	}
	return 0
}
...
type ScionState struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Supported      bool                   `protobuf:"varint,1,opt,name=supported,proto3" json:"supported,omitempty"`
	Enabled        bool                   `protobuf:"varint,2,opt,name=enabled,proto3" json:"enabled,omitempty"`
	Active         bool                   `protobuf:"varint,3,opt,name=active,proto3" json:"active,omitempty"`
	LocalIA        string                 `protobuf:"bytes,4,opt,name=localIA,proto3" json:"localIA,omitempty"`
	LocalAddress   string                 `protobuf:"bytes,5,opt,name=localAddress,proto3" json:"localAddress,omitempty"`
	ConnectedPeers int32                  `protobuf:"varint,6,opt,name=connectedPeers,proto3" json:"connectedPeers,omitempty"`
	LastError      string                 `protobuf:"bytes,7,opt,name=lastError,proto3" json:"lastError,omitempty"`
	RefreshHealth  string                 `protobuf:"bytes,8,opt,name=refreshHealth,proto3" json:"refreshHealth,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *ScionState) Reset() {
	*x = ScionState{}
...
func (x *ScionState) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ScionState) ProtoMessage() {}

func (x *ScionState) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ScionState.ProtoReflect.Descriptor instead.
func (*ScionState) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{21}
}

func (x *ScionState) GetSupported() bool {
	if x != nil {
		return x.Supported
	}
	return false
...
func (x *ScionState) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *ScionState) GetActive() bool {
	if x != nil {
		return x.Active
	}
	return false
...
func (x *ScionState) GetLocalIA() string {
	if x != nil {
		return x.LocalIA
	}
	return ""
...
func (x *ScionState) GetLocalAddress() string {
	if x != nil {
...
func (x *ScionState) GetConnectedPeers() int32 {
	if x != nil {
...
func (x *ScionState) GetLastError() string {
	if x != nil {
		return x.LastError
	}
	return ""
...
func (x *ScionState) GetRefreshHealth() string {
	if x != nil {
		return x.RefreshHealth
	}
	return ""
}
...
type FullStatus struct {
	...
	ScionState       *ScionState `protobuf:"bytes,12,opt,name=scionState,proto3" json:"scionState,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *FullStatus) GetScionState() *ScionState {
	if x != nil {
		return x.ScionState
	}
	return nil
...
const file_daemon_proto_rawDesc = "" +
	...
	"\x10mDMManagedFields\x18\x1c \x03(\tR\x10mDMManagedFields\"\xb9\a\n" +
	"\tPeerState\x12\x0e\n" +
	...
	"\vscionActive\x18\x15 \x01(\bR\vscionActive\x12\x1c\n" +
	"\tscionPath\x18\x16 \x01(\tR\tscionPath\x12=\n" +
	"\fscionLatency\x18\x17 \x01(\v2\x19.google.protobuf.DurationR\fscionLatency\x12&\n" +
	"\x0escionPathCount\x18\x18 \x01(\x05R\x0escionPathCount\"\x9c\x02\n" +
	...
	"\bsessions\x18\x02 \x03(\v2\x16.daemon.SSHSessionInfoR\bsessions\"\x86\x02\n" +
	"\n" +
	"ScionState\x12\x1c\n" +
	...
	"\alocalIA\x18\x04 \x01(\tR\alocalIA\x12\"\n" +
	"\flocalAddress\x18\x05 \x01(\tR\flocalAddress\x12&\n" +
	"\x0econnectedPeers\x18\x06 \x01(\x05R\x0econnectedPeers\x12\x1c\n" +
	"\tlastError\x18\a \x01(\tR\tlastError\x12$\n" +
	"\rrefreshHealth\x18\b \x01(\tR\rrefreshHealth\"\x8f\x05\n" +
	"\n" +
	"FullStatus\x12A\n" +
	...
	"\x10networksRevision\x18\v \x01(\x04R\x10networksRevision\x122\n" +
	"\n" +
	"scionState\x18\f \x01(\v2\x12.daemon.ScionStateR\n" +
	"scionState\"\x15\n" +
...
var file_daemon_proto_goTypes = []any{
	...
	(*ScionState)(nil),                         // 25: daemon.ScionState
	...
	(*RegisterUILogRequest)(nil),               // 42: daemon.RegisterUILogRequest
	(*RegisterUILogResponse)(nil),              // 43: daemon.RegisterUILogResponse
	...
	(*RenameProfileRequest)(nil),               // 67: daemon.RenameProfileRequest
	(*RenameProfileResponse)(nil),              // 68: daemon.RenameProfileResponse
	...
	(*WailsUIReadyRequest)(nil),                // 78: daemon.WailsUIReadyRequest
	(*WailsUIReadyResponse)(nil),               // 79: daemon.WailsUIReadyResponse
	(*GetFeaturesRequest)(nil),                 // 80: daemon.GetFeaturesRequest
	(*GetFeaturesResponse)(nil),                // 81: daemon.GetFeaturesResponse
	(*MDMManagedFieldsViolation)(nil),          // 82: daemon.MDMManagedFieldsViolation
	(*TriggerUpdateRequest)(nil),               // 83: daemon.TriggerUpdateRequest
	(*TriggerUpdateResponse)(nil),              // 84: daemon.TriggerUpdateResponse
	(*GetPeerSSHHostKeyRequest)(nil),           // 85: daemon.GetPeerSSHHostKeyRequest
	(*GetPeerSSHHostKeyResponse)(nil),          // 86: daemon.GetPeerSSHHostKeyResponse
	(*RequestJWTAuthRequest)(nil),              // 87: daemon.RequestJWTAuthRequest
	(*RequestJWTAuthResponse)(nil),             // 88: daemon.RequestJWTAuthResponse
	(*WaitJWTTokenRequest)(nil),                // 89: daemon.WaitJWTTokenRequest
	(*WaitJWTTokenResponse)(nil),               // 90: daemon.WaitJWTTokenResponse
	(*RequestExtendAuthSessionRequest)(nil),    // 91: daemon.RequestExtendAuthSessionRequest
	(*RequestExtendAuthSessionResponse)(nil),   // 92: daemon.RequestExtendAuthSessionResponse
	(*WaitExtendAuthSessionRequest)(nil),       // 93: daemon.WaitExtendAuthSessionRequest
	(*WaitExtendAuthSessionResponse)(nil),      // 94: daemon.WaitExtendAuthSessionResponse
	(*DismissSessionWarningRequest)(nil),       // 95: daemon.DismissSessionWarningRequest
	(*DismissSessionWarningResponse)(nil),      // 96: daemon.DismissSessionWarningResponse
	(*StartCPUProfileRequest)(nil),             // 97: daemon.StartCPUProfileRequest
	(*StartCPUProfileResponse)(nil),            // 98: daemon.StartCPUProfileResponse
	(*StopCPUProfileRequest)(nil),              // 99: daemon.StopCPUProfileRequest
	(*StopCPUProfileResponse)(nil),             // 100: daemon.StopCPUProfileResponse
	(*InstallerResultRequest)(nil),             // 101: daemon.InstallerResultRequest
	(*InstallerResultResponse)(nil),            // 102: daemon.InstallerResultResponse
	(*ExposeServiceRequest)(nil),               // 103: daemon.ExposeServiceRequest
	(*ExposeServiceEvent)(nil),                 // 104: daemon.ExposeServiceEvent
	(*ExposeServiceReady)(nil),                 // 105: daemon.ExposeServiceReady
	(*StartCaptureRequest)(nil),                // 106: daemon.StartCaptureRequest
	(*CapturePacket)(nil),                      // 107: daemon.CapturePacket
	(*StartBundleCaptureRequest)(nil),          // 108: daemon.StartBundleCaptureRequest
	(*StartBundleCaptureResponse)(nil),         // 109: daemon.StartBundleCaptureResponse
	(*StopBundleCaptureRequest)(nil),           // 110: daemon.StopBundleCaptureRequest
	(*StopBundleCaptureResponse)(nil),          // 111: daemon.StopBundleCaptureResponse
	nil,                                        // 112: daemon.Network.ResolvedIPsEntry
	(*PortInfo_Range)(nil),                     // 113: daemon.PortInfo.Range
	nil,                                        // 114: daemon.SystemEvent.MetadataEntry
...
var file_daemon_proto_depIdxs = []int32{
	...
	115, // 6: daemon.PeerState.scionLatency:type_name -> google.protobuf.Duration
	...
	58,  // 14: daemon.FullStatus.events:type_name -> daemon.SystemEvent
	24,  // 15: daemon.FullStatus.sshServerState:type_name -> daemon.SSHServerState
	25,  // 16: daemon.FullStatus.scionState:type_name -> daemon.ScionState
	32,  // 17: daemon.ListNetworksResponse.routes:type_name -> daemon.Network
	112, // 18: daemon.Network.resolvedIPs:type_name -> daemon.Network.ResolvedIPsEntry
	113, // 19: daemon.PortInfo.range:type_name -> daemon.PortInfo.Range
	...
	44,  // 25: daemon.ListStatesResponse.states:type_name -> daemon.State
	53,  // 26: daemon.TracePacketRequest.tcp_flags:type_name -> daemon.TCPFlags
	55,  // 27: daemon.TracePacketResponse.stages:type_name -> daemon.TraceStage
	...
	116, // 30: daemon.SystemEvent.timestamp:type_name -> google.protobuf.Timestamp
	114, // 31: daemon.SystemEvent.metadata:type_name -> daemon.SystemEvent.MetadataEntry
	58,  // 32: daemon.GetEventsResponse.events:type_name -> daemon.SystemEvent
	115, // 33: daemon.SetConfigRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	73,  // 34: daemon.ListProfilesResponse.profiles:type_name -> daemon.Profile
	116, // 35: daemon.WaitExtendAuthSessionResponse.sessionExpiresAt:type_name -> google.protobuf.Timestamp
	1,   // 36: daemon.ExposeServiceRequest.protocol:type_name -> daemon.ExposeProtocol
	105, // 37: daemon.ExposeServiceEvent.ready:type_name -> daemon.ExposeServiceReady
	115, // 38: daemon.StartCaptureRequest.duration:type_name -> google.protobuf.Duration
	115, // 39: daemon.StartBundleCaptureRequest.timeout:type_name -> google.protobuf.Duration
	31,  // 40: daemon.Network.ResolvedIPsEntry.value:type_name -> daemon.IPList
	...
	27,  // 48: daemon.DaemonService.ListNetworks:input_type -> daemon.ListNetworksRequest
	29,  // 49: daemon.DaemonService.SelectNetworks:input_type -> daemon.SelectNetworksRequest
	29,  // 50: daemon.DaemonService.DeselectNetworks:input_type -> daemon.SelectNetworksRequest
	4,   // 51: daemon.DaemonService.ForwardingRules:input_type -> daemon.EmptyRequest
	36,  // 52: daemon.DaemonService.DebugBundle:input_type -> daemon.DebugBundleRequest
	38,  // 53: daemon.DaemonService.GetLogLevel:input_type -> daemon.GetLogLevelRequest
	40,  // 54: daemon.DaemonService.SetLogLevel:input_type -> daemon.SetLogLevelRequest
	45,  // 55: daemon.DaemonService.ListStates:input_type -> daemon.ListStatesRequest
	47,  // 56: daemon.DaemonService.CleanState:input_type -> daemon.CleanStateRequest
	49,  // 57: daemon.DaemonService.DeleteState:input_type -> daemon.DeleteStateRequest
	51,  // 58: daemon.DaemonService.SetSyncResponsePersistence:input_type -> daemon.SetSyncResponsePersistenceRequest
	54,  // 59: daemon.DaemonService.TracePacket:input_type -> daemon.TracePacketRequest
	106, // 60: daemon.DaemonService.StartCapture:input_type -> daemon.StartCaptureRequest
	108, // 61: daemon.DaemonService.StartBundleCapture:input_type -> daemon.StartBundleCaptureRequest
	110, // 62: daemon.DaemonService.StopBundleCapture:input_type -> daemon.StopBundleCaptureRequest
	57,  // 63: daemon.DaemonService.SubscribeEvents:input_type -> daemon.SubscribeRequest
	59,  // 64: daemon.DaemonService.GetEvents:input_type -> daemon.GetEventsRequest
	42,  // 65: daemon.DaemonService.RegisterUILog:input_type -> daemon.RegisterUILogRequest
	61,  // 66: daemon.DaemonService.SwitchProfile:input_type -> daemon.SwitchProfileRequest
	63,  // 67: daemon.DaemonService.SetConfig:input_type -> daemon.SetConfigRequest
	65,  // 68: daemon.DaemonService.AddProfile:input_type -> daemon.AddProfileRequest
	67,  // 69: daemon.DaemonService.RenameProfile:input_type -> daemon.RenameProfileRequest
	69,  // 70: daemon.DaemonService.RemoveProfile:input_type -> daemon.RemoveProfileRequest
	71,  // 71: daemon.DaemonService.ListProfiles:input_type -> daemon.ListProfilesRequest
	74,  // 72: daemon.DaemonService.GetActiveProfile:input_type -> daemon.GetActiveProfileRequest
	76,  // 73: daemon.DaemonService.Logout:input_type -> daemon.LogoutRequest
	80,  // 74: daemon.DaemonService.GetFeatures:input_type -> daemon.GetFeaturesRequest
	83,  // 75: daemon.DaemonService.TriggerUpdate:input_type -> daemon.TriggerUpdateRequest
	85,  // 76: daemon.DaemonService.GetPeerSSHHostKey:input_type -> daemon.GetPeerSSHHostKeyRequest
	87,  // 77: daemon.DaemonService.RequestJWTAuth:input_type -> daemon.RequestJWTAuthRequest
	89,  // 78: daemon.DaemonService.WaitJWTToken:input_type -> daemon.WaitJWTTokenRequest
	91,  // 79: daemon.DaemonService.RequestExtendAuthSession:input_type -> daemon.RequestExtendAuthSessionRequest
	93,  // 80: daemon.DaemonService.WaitExtendAuthSession:input_type -> daemon.WaitExtendAuthSessionRequest
	95,  // 81: daemon.DaemonService.DismissSessionWarning:input_type -> daemon.DismissSessionWarningRequest
	97,  // 82: daemon.DaemonService.StartCPUProfile:input_type -> daemon.StartCPUProfileRequest
	99,  // 83: daemon.DaemonService.StopCPUProfile:input_type -> daemon.StopCPUProfileRequest
	101, // 84: daemon.DaemonService.GetInstallerResult:input_type -> daemon.InstallerResultRequest
	103, // 85: daemon.DaemonService.ExposeService:input_type -> daemon.ExposeServiceRequest
	78,  // 86: daemon.DaemonService.WailsUIReady:input_type -> daemon.WailsUIReadyRequest
	...
	28,  // 94: daemon.DaemonService.ListNetworks:output_type -> daemon.ListNetworksResponse
	30,  // 95: daemon.DaemonService.SelectNetworks:output_type -> daemon.SelectNetworksResponse
	30,  // 96: daemon.DaemonService.DeselectNetworks:output_type -> daemon.SelectNetworksResponse
	35,  // 97: daemon.DaemonService.ForwardingRules:output_type -> daemon.ForwardingRulesResponse
	37,  // 98: daemon.DaemonService.DebugBundle:output_type -> daemon.DebugBundleResponse
	39,  // 99: daemon.DaemonService.GetLogLevel:output_type -> daemon.GetLogLevelResponse
	41,  // 100: daemon.DaemonService.SetLogLevel:output_type -> daemon.SetLogLevelResponse
	46,  // 101: daemon.DaemonService.ListStates:output_type -> daemon.ListStatesResponse
	48,  // 102: daemon.DaemonService.CleanState:output_type -> daemon.CleanStateResponse
	50,  // 103: daemon.DaemonService.DeleteState:output_type -> daemon.DeleteStateResponse
	52,  // 104: daemon.DaemonService.SetSyncResponsePersistence:output_type -> daemon.SetSyncResponsePersistenceResponse
	56,  // 105: daemon.DaemonService.TracePacket:output_type -> daemon.TracePacketResponse
	107, // 106: daemon.DaemonService.StartCapture:output_type -> daemon.CapturePacket
	109, // 107: daemon.DaemonService.StartBundleCapture:output_type -> daemon.StartBundleCaptureResponse
	111, // 108: daemon.DaemonService.StopBundleCapture:output_type -> daemon.StopBundleCaptureResponse
	58,  // 109: daemon.DaemonService.SubscribeEvents:output_type -> daemon.SystemEvent
	60,  // 110: daemon.DaemonService.GetEvents:output_type -> daemon.GetEventsResponse
	43,  // 111: daemon.DaemonService.RegisterUILog:output_type -> daemon.RegisterUILogResponse
	62,  // 112: daemon.DaemonService.SwitchProfile:output_type -> daemon.SwitchProfileResponse
	64,  // 113: daemon.DaemonService.SetConfig:output_type -> daemon.SetConfigResponse
	66,  // 114: daemon.DaemonService.AddProfile:output_type -> daemon.AddProfileResponse
	68,  // 115: daemon.DaemonService.RenameProfile:output_type -> daemon.RenameProfileResponse
	70,  // 116: daemon.DaemonService.RemoveProfile:output_type -> daemon.RemoveProfileResponse
	72,  // 117: daemon.DaemonService.ListProfiles:output_type -> daemon.ListProfilesResponse
	75,  // 118: daemon.DaemonService.GetActiveProfile:output_type -> daemon.GetActiveProfileResponse
	77,  // 119: daemon.DaemonService.Logout:output_type -> daemon.LogoutResponse
	81,  // 120: daemon.DaemonService.GetFeatures:output_type -> daemon.GetFeaturesResponse
	84,  // 121: daemon.DaemonService.TriggerUpdate:output_type -> daemon.TriggerUpdateResponse
	86,  // 122: daemon.DaemonService.GetPeerSSHHostKey:output_type -> daemon.GetPeerSSHHostKeyResponse
	88,  // 123: daemon.DaemonService.RequestJWTAuth:output_type -> daemon.RequestJWTAuthResponse
	90,  // 124: daemon.DaemonService.WaitJWTToken:output_type -> daemon.WaitJWTTokenResponse
	92,  // 125: daemon.DaemonService.RequestExtendAuthSession:output_type -> daemon.RequestExtendAuthSessionResponse
	94,  // 126: daemon.DaemonService.WaitExtendAuthSession:output_type -> daemon.WaitExtendAuthSessionResponse
	96,  // 127: daemon.DaemonService.DismissSessionWarning:output_type -> daemon.DismissSessionWarningResponse
	98,  // 128: daemon.DaemonService.StartCPUProfile:output_type -> daemon.StartCPUProfileResponse
	100, // 129: daemon.DaemonService.StopCPUProfile:output_type -> daemon.StopCPUProfileResponse
	102, // 130: daemon.DaemonService.GetInstallerResult:output_type -> daemon.InstallerResultResponse
	104, // 131: daemon.DaemonService.ExposeService:output_type -> daemon.ExposeServiceEvent
	79,  // 132: daemon.DaemonService.WailsUIReady:output_type -> daemon.WailsUIReadyResponse
...
func file_daemon_proto_init() {
	...
	file_daemon_proto_msgTypes[83].OneofWrappers = []any{}
	file_daemon_proto_msgTypes[87].OneofWrappers = []any{}
	file_daemon_proto_msgTypes[100].OneofWrappers = []any{
